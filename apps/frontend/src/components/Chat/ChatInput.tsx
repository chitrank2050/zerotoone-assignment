...
export const ChatInput: React.FC = () => {
  ...
  return (
    <div className="border-t border-neutral-900 bg-neutral-950 p-6">
      <form
        onSubmit={handleSend}
      ...
      >
        ...
        <input
          ...
          className="flex-1 bg-transparent border-none outline-none text-sm text-neutral-100 placeholder:text-neutral-600 font-medium"
        />
        <button
          type="submit"
